...
from core.utils import caches_config, default_renderer_classes
...
DEV_SECRET_KEY = "dev-secret-key-for-local-development-only"
SECRET_KEY = os.getenv("SECRET_KEY", DEV_SECRET_KEY)
DEBUG = env_bool("DEBUG", False)

if not DEBUG and not TESTING and SECRET_KEY == DEV_SECRET_KEY:
...
DRUG_LOOKUP_ALLOWED_HOSTS = env_list("DRUG_LOOKUP_ALLOWED_HOSTS", "")

REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "rest_framework_simplejwt.authentication.JWTAuthentication",
    ],
    "DEFAULT_RENDERER_CLASSES": default_renderer_classes(DEBUG),
...
DEFAULT_LOG_LEVEL = "CRITICAL" if TESTING else "INFO"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "django_structlog": {"handlers": ["console"], "level": DEFAULT_LOG_LEVEL, "propagate": False},
    },
}
